            ...
            <el-card class="!border-none mb-4 flex-1" shadow="never">
                ...
                <div class="flex flex-wrap">
                    <div class="w-1/2 md:w-1/5">
                        ...
                        <div class="leading-10">今日新增用户数</div>
                    ...
                    <div class="w-1/2 md:w-1/5">
                        ...
                        <div class="leading-10">今日新增订单数</div>
                    ...
                    <div class="w-1/2 md:w-1/5">
                        ...
                        <div class="leading-10">今日新增订单金额</div>
                        <div class="text-6xl">{{ workbenchData.today.today_order_total }}</div>
                    </div>
                    <div class="w-1/2 md:w-1/5">
                        <div class="leading-10">销售卡总数</div>
                        <div class="text-6xl">{{ workbenchData.today.total_sales }}</div>
                        <div class="leading-10">今日新增销售卡数</div>
                    ...
                    <div class="w-1/2 md:w-1/5">
                        ...
                        <div class="leading-10">今日复充人数</div>
                        <div class="text-6xl">{{ workbenchData.today.repeat_recharge_count }}</div>
                    </div>
                </div>
            </el-card>
        </div>
