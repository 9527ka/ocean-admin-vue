<template>
    <div>
        <el-card class="!border-none mb-4" shadow="never">
            <el-form class="mb-[-16px]" :model="queryParams" inline>
                ...
                <el-form-item label="推荐" prop="is_recommend">
                    <el-select class="w-[280px]" v-model="queryParams.is_recommend" clearable placeholder="请选择推荐">
        ...
        <el-card class="!border-none" v-loading="pager.loading" shadow="never">
            <el-button v-perms="['plants/add']" type="primary" @click="handleAdd">
                <template #icon>
                    <icon name="el-icon-Plus" />
                </template>
                新增
            </el-button>
            <el-button v-perms="['plants/delete']" :disabled="!selectData.length" @click="handleDelete(selectData)">
                删除
            </el-button>
            <div class="mt-4">
                <el-table :data="pager.lists" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="推荐" prop="is_recommend">
                    ...
                    <el-table-column label="操作" width="120" fixed="right">
                        <template #default="{ row }">
                            <el-button v-perms="['plants/edit']" type="primary" link @click="handleEdit(row)">
                                编辑
                            </el-button>
                            <el-button v-perms="['plants/delete']" type="danger" link @click="handleDelete(row.id)">
                                删除
                            </el-button>
                        </template>
                    </el-table-column>
...
<script lang="ts" setup name="plantsLists">
import { usePaging } from '@/hooks/usePaging'
import { useDictData } from '@/hooks/useDictOptions'
import { apiPlantsLists, apiPlantsDelete } from '@/api/plants'
...
// 获取字典数据
const { dictData } = useDictData('is_recommend,show_status,lang_list')

// 分页相关
const { pager, getLists, resetParams, resetPage } = usePaging({
    fetchFun: apiPlantsLists,
    params: queryParams
})
